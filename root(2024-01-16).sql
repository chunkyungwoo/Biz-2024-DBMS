...
-- CREATE DATABASE, CREATE TABLE, CREATE USER 대표적인 명령어
...
-- Table 에 추가하기
-- INSERT INTO [table] ([colums]) VALUES (값들)
...
-- projectoin 설정하기(필요한 칼럼만 선택해서 보는것을의미)
...
CREATE TABLE tbl_professor(
	p_num	VARCHAR(4)	PRIMARY KEY,
	p_name	VARCHAR(10)	NOT NULL,
	p_tel	VARCHAR(13)	NOT NULL	
);

INSERT INTO tbl_professor(p_num,p_name,p_tel)
