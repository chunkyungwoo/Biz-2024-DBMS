...
io_dname,io_dceo,io_div,io_quan,io_iprice,io_oprice
)
VALUES
...
('2023-01-03','10:13:37','심플(갑)','토성농협하나로마트본점','강이찬','2','6','1','2300'),
('2023-01-05','10:25:49','연양갱','동해삼척태백축협하나로마트제2판매장','견장혁','2','5','600','0'),
('2023-01-06','10:27:18','(신)허쉬드링크','원덕농협하나로마트본점','개성현','2','60','0','800'),
('2023-01-06','10:29:38','(신)허쉬드링크','동해삼척태백축협하나로마트본점','견준상','2','55','0','800'),
('2023-01-07','10:32:30','인디고','강원양돈농협 본점하나로마트','간채민','1','5','1844','0'),
('2023-01-08','10:37:12','(신)허쉬드링크','북강릉농협하나로마트연곡점','강연호','1','76','393','0'),
('2023-01-09','10:40:24','순두유230m','동해삼척태백축협하나로마트본점','견준상','1','89','614','0'),
('2023-01-10','10:42:51','아카시아후레쉬','강릉농협하나로마트강동점','강원일','1','74','737','0');

-- tbl_iolist 테이블에 저장된 데이터의 개수가 몇개있는지
-- 데이터의 레코드수가 몇개
SELECT COUNT(io_seq)
FROM tbl_iolist;
...
-- 거래구분(io_div)이 2이고
-- 거래수량이(id_quan) 50개 이하인
-- 데이터만 SELECTION

SELECT *
FROM tbl_iolist
WHERE io_div = '2' AND io_quan < 51; 
...
/*
상품명(io_pname)이 같은 값끼리 GROUP 을 만들어라
